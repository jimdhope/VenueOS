...
export default function ScreenModal({ isOpen, onClose, screen, spaces, playlists, timecodes }: ScreenModalProps) {
    ...
    // Initialize resolution option when opening modal (edit case)
    useEffect(() => {
        if (!isOpen) return;
        ...
        <div className={styles.overlay}>
            <div className={styles.modal}>
                ...
                >
                    ...
                    <div className={styles.formGroup}>
                        <label htmlFor="playlistId">Assigned Playlist</label>
                        <select
                            id="playlistId"
                            name="playlistId"
                    ...
                    <div className={styles.formGroup}>
                        <label>Matrix Display Position (for multi-screen layouts)</label>
                        ...
                        <small style={{ display: 'block', marginTop: '4px' }}>Leave empty for single-screen (no cropping)</small>
                    </div>
                    ...
                    <div className={styles.formGroup}>
                        ...
                        {/* Hidden resolution value passed to server action */}
                        <input
                            type="hidden"
                            id="resolution"
                            name="resolution"
                    ...
                    {/* Status is managed automatically via heartbeat; do not allow manual editing here */}
